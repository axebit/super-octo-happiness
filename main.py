...
class GreenEnergy(MDApp):
    ...
    def usage_data(self):
        ...
        # Initialize Firebase
        firebase = firebase.FirebaseApplication('https://greenenergydatabase-default-rtdb.firebaseio.com/', None)

        try:

            result = firebase.get('greenenergydatabase-default-rtdb/ApplianceData', '')
            total = 0
            etotal = 0
            d_cost = 0
            m_cost = 0
    ...
    def add_todo(self, appliance, quantity, hours, wattage):
        ...
        if appliance != "" and quantity != "" and hours != "" and wattage != "" and len(appliance) < 21 and len(
            ...
            try:
                ...
                a_result = firebase.get('greenenergydatabase-default-rtdb/ApplianceData', '')
                print(" ")
                # print(f_result)
            ...
            if a_result is None:
                ...
                firebase.post('greenenergydatabase-default-rtdb/ApplianceData', new_appliance_data)
    ...
    def get_data(self, institution, facility, room, nationalid):
        ...
        if institution != "" and facility != "" and room != "" and nationalid != "" and len(institution) > 5 and len(
            ...
            try:
                ...
                f_result = firebase.get('greenenergydatabase-default-rtdb/FacilityData', '')
                #print(" ")
                # print(f_result)
            ...
            if f_result is None:
                ...
                firebase.post('greenenergydatabase-default-rtdb/FacilityData', new_facility_data)
                # print(institution + " data inserted successfully!")
        ...
        if name == "":
            ...
            # print("Valid Email")
                ...
                try:
                    ...
                    c_result = firebase.get('greenenergydatabase-default-rtdb/ContactData', '')
                    ...
                    if c_result is None:
                        ...
                        firebase.post('greenenergydatabase-default-rtdb/ContactData', new_contact_data)
                        # print(institution + " data inserted successfully!")
    ...
    def signup_data(self, nickname, new_email, new_password):
        ...
        if (re.fullmatch(regex, new_email)):
            ...
            try:
                ...
                result = firebase.get('greenenergydatabase-default-rtdb/Users', '')
                # print(result)
                ...
                if (result == None):
                    ...
                    try:
                        ...
                        firebase.post('greenenergydatabase-default-rtdb/Users', new_data)
